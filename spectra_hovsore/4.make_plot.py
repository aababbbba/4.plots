...
plt.loglog(modif_eta1[:,0], modif_eta1[:,0]**2.0*modif_eta1[:,1]**2.0,lw=1.3,label=r"$\eta_1\approx$ 5.25 [m]")
plt.loglog(modif_eta2[:,0], modif_eta2[:,0]**2.0*modif_eta2[:,1]**2.0,lw=1.3,label=r"$\eta_2\approx$ 15.75 [m]")
plt.loglog(modif_eta3[:,0], modif_eta3[:,0]**2.0*modif_eta3[:,1]**2.0,lw=1.3,label=r"$\eta_3\approx$ 26.26 [m]")
plt.loglog(modif_eta4[:,0], modif_eta4[:,0]**2.0*modif_eta4[:,1]**2.0,lw=1.3,label=r"$\eta_4\approx$ 36.78 [m]")
plt.loglog(modif_eta5[:,0], modif_eta5[:,0]**2.0*modif_eta5[:,1]**2.0,lw=1.3,label=r"$\eta_5\approx$ 49.57 [m]")
